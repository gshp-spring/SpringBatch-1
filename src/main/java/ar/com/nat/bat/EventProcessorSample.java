...
public class EventProcessorSample
{
    ...
    {
    	//Endpoint=sb://sriharilabas.servicebus.windows.net/;SharedAccessKeyName=sriharilabssharedaccess;SharedAccessKey=CKzlNyz6oQVikulCtlDleUYrN73YFB5xyl3kOBRzJm8=
    	...
    	String sasKeyName ="RootManageSharedAccessKey";          //"----SharedAccessSignatureKeyName----";
    	String sasKey = "f5n3qZD1V2Obfcguh3vjpAzYhnPZaqxMf7sDDGn67Gc=";   // "----SharedAccessSignatureKey----";
    	//Endpoint=sb://sriharilabas.servicebus.windows.net/;SharedAccessKeyName=sriharilabssharedaccess;SharedAccessKey=CKzlNyz6oQVikulCtlDleUYrN73YFB5xyl3kOBRzJm8="
    	//String storageConnectionString ="DefaultEndpointsProtocol=https;AccountName=sriharilabs1;AccountKey=siNQCnh9fsPRHw8L5K5S2BhpRV1pKTpFjzqaYw01cEA=;EndpointSuffix=core.windows.net";//"----AzureStorageConnectionString----";
    	...
    	String hostNamePrefix ="sriharilabs-host";// "----sriharilabs----";
